  ...
  return (
    <section className="py-24 md:py-36 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 border border-gray-200 max-w-5xl overflow-hidden">
          {/* Included */}
          <motion.div
            initial={{ opacity: 0, x: -16 }}
            animate={inView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 0.5, delay: 0.1 }}
            className="bg-[#0a2e2c] p-8 md:p-10 md:border-r border-white/10"
          >
            <p className="text-[#f5a623] text-xs font-bold uppercase tracking-[0.2em] mb-8">
              Cena zahrnuje
            </p>
          ...
          >
            <div className="p-8 md:p-10 flex-1 border-b border-gray-200">
            ...
            <div className="p-8 md:p-10 bg-[#f5f0e8]">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#0a2e2c] mb-2">
                Tip pro rodiče
              </p>
